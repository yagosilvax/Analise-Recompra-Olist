...
## Contexto
Este projeto analisa os principais fatores relacionados ao comportamento de recompra dos clientes do e-commerce brasileiro Olist, sendo uma extensão do [projeto de ETL]([link_do_seu_etl](https://github.com/yagosilvax/Projeto_Pipeline_ETL)) do mesmo dataset.
